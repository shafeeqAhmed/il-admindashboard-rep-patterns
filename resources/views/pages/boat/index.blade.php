                                            ...
                                            <table class="table table-striped table-bordered base-style">
                                                ...
                                                @foreach($records as $key => $record)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ ucfirst($record['user']['first_name']) }}
                                                        </td>
                                                        <td>
                                                            {{ $record['boat_type']['name']  }}
                                                        </td>
{{--                                                        <td>--}}
{{--                                                            @if($record['is_active'])--}}
{{--                                                                <div class="badge border-success success badge-border">Active</div>--}}
{{--                                                            @else--}}
{{--                                                                <div class="badge border-danger danger badge-border">Inactive</div>--}}
{{--                                                            @endif--}}
{{--                                                        </td>--}}
                                                        <td>
                                                        ...
                                                        <td class="text-center">
                                                            <a type="button" href="{{ route('admin.boats.show',['uuid'=>$record['boat_uuid']]) }}"
