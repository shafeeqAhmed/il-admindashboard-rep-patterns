                                        ...
                                        <form method="post" enctype="multipart/form-data" action="{{route('admin.boatTypes.update',['boatType'=>$type['boat_type_uuid']])}}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" name="is_active">
                                                                    <option @if($type['is_active'] ==  1) selected @endif value="1">Active</option>
                                                                    <option @if($type['is_active'] ==  0) selected @endif value="0">Inactive</option>
                                                            </select>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        ?>
                                                        <div>
                                                            <img id="boat_type_picture_preview" class="position-relative"
                                                                 src="{{ $type['pic'] }}" alt="">


                                                            <i class="ft-x-circle x3 position-absolute danger"
                                                        ...
                                                        {{--                                                        <input type="file" name="name"  class="form-control" id="boat_type_picture" >--}}
                                                        {{--                                                    </div>--}}
                                                    </div>
                                                    <div class="col-md-3"></div>
                                                </div>
                                            ...
                                            <fieldset>
                                                <div class="row pull-right">
                                                    <a href="{{route('admin.boatTypes.index')}}" class="btn btn-light btn-min-width btn-glow mr-1 mb-1">Cancel</a>
                                                    <button type="submit" class="btn btn-success btn-min-width btn-glow mr-1 mb-1">Submit</button>
                                                </div>
                                            </fieldset>
                                        </form>
                                    </div>
