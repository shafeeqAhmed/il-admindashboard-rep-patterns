                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <form method="POST" enctype="multipart/form-data"
                                            action="{{ route('admin.settings.update', ['uuid' => $record->system_setting_uuid]) }}">
                                            @csrf
                                            <fieldset>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input min="1" step="any"
                                                                placeholder="Update value added tax in percentage"
                                                                name="vat" type="number" value="{{ $record->vat }}"
                                                                class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="firstName2">Boatek Commission Charges (%) :</label>
                                                            <input min="1" step="any"
                                                                placeholder="Update Boatek Commission Charges in percentage"
                                                                name="boatek_commission_charges" name="vat" type="number"
                                                                value="{{ $record->boatek_commission_charges }}"
                                                                class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input min="1" step="any"
                                                                placeholder="Update Transaction Charges in percentage"
                                                                name="transaction_charges" type="number"
                                                                value="{{ $record->transaction_charges }}"
                                                                class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="firstName2">Withdraw Duration in Week :</label>
                                                            <select class="select2 form-control"
                                                                name="withdraw_scheduled_duration" required>
                                                                <option disabled value=""> -- Select -- </option>
                                                                <option
                                                                    {{ $record->withdraw_scheduled_duration == '0' ? 'selected' : '' }}
                                                                    value="0">
                                                                    One Week
                                                                </option>
                                                                <option value="1"
                                                                    {{ $record->withdraw_scheduled_duration == '1' ? 'selected' : '' }}>
                                                                    Two Week
                                                                </option>
                                                                <option
                                                                    {{ $record->withdraw_scheduled_duration == '2' ? 'selected' : '' }}
                                                                    value="2">
                                                                    One Month
                                                                </option>
                                                            </select>
                                            ...
                                            <fieldset>
                                                <div class="row pull-right">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-info btn-min-width btn-glow mr-1 mb-1">
                                                        Update
                                                    </button>
                                                </div>
                                            </fieldset>
